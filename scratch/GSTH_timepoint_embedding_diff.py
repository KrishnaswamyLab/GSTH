...
plt.savefig('hyperstack_220114_14-27-24_green_100to500t_ALL_CELLS_plus',dpi=600)

fig = plt.figure(figsize=(16,8))
ax1 = plt.subplot2grid(shape=(1,1), loc=(0,0),projection='3d')
im1 = ax1.scatter(phate_data_all[1][:,0],phate_data_all[1][:,1],phate_data_all[1][:,2],c=time_point_all[1],s=5,cmap='inferno')
fig.colorbar(im1, ax=ax1,fraction=0.015,pad=0.08)
plt.savefig('hyperstack_220114_15-25-01_green_100to500t_MC_ALL_CELLS_plus',dpi=600)

fig = plt.figure(figsize=(16,8))
ax1 = plt.subplot2grid(shape=(1,1), loc=(0,0),projection='3d')
im1 = ax1.scatter(phate_data_all[2][:,0],phate_data_all[2][:,1],phate_data_all[2][:,2],c=time_point_all[2],s=5,cmap='inferno')
fig.colorbar(im1, ax=ax1,fraction=0.015,pad=0.08)
plt.savefig('hyperstack_220114_15-57-35_green_MC_ALL_CELLS_plus',dpi=600)
